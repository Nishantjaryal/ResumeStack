...
export async function generateAiInterviewFeedback({
    ...
    humeChatId: string,
    jobInfo: Pick<typeof JobInfoTable.$inferSelect, "jobTitle"| "experiencelevel"| "description">,
    ...
    if(messages.length === 0) {
        return {
            error: true,
            message: "No messages found for this interview, cannot generate feedback"
        }
    }
